            ...
            <div class="modal-container">
                ...
                <div class="modal-body d-flex justify-content-center flex-column" style="font-size:1.25rem;">
                    <div class="text-center">
                        ...
                        {{ getDescription(appointToRemove) }}?
                    </div>
...
export default {
    ...
    methods : {
        ...
        getDescription : function(appointToRemove)
        {
            if (appointToRemove.hasOwnProperty('appCDate'))
            {
                return ("на " + appointToRemove.appCDate.substring(0, appointToRemove.appCDate.indexOf("-") - 1))
            }
            else if (appointToRemove.day.hasOwnProperty('dat'))
            {
                return ("на " + appointToRemove.day.dat)
            }
            else
            {
                return ("выбранные на период " + appointToRemove.speciality.week.short)
            }
        }
    }
}
